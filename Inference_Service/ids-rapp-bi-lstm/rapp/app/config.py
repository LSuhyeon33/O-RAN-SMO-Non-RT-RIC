...
KSERVE_HOST = os.environ.get('KSERVE_HOST', 'http://bi-lstm-riclog.kserve-test.svc.cluster.local')
MODEL_NAME = os.environ.get('MODEL_NAME', 'bi-lstm-riclog')
...
MODEL_ZIP_URL = os.environ.get(
    'MODEL_ZIP_URL',
    'http://210.123.36.94:32002/model/bi-lstm-03/1/1.0.0/Model.zip')
...
RESULTS_DIR = os.environ.get('RESULTS_DIR', '/results/bi-lstm-riclog')
