...
KSERVE_HOST = os.environ.get('KSERVE_HOST', 'http://xgboost-riclog.kserve-test.svc.cluster.local')
MODEL_NAME = os.environ.get('MODEL_NAME', 'xgboost-riclog')
...
MODEL_ZIP_URL = os.environ.get(
    'MODEL_ZIP_URL',
    'http://210.123.36.94:32002/model/xgboost-12/1/1.0.0/Model.zip')
...
RESULTS_DIR = os.environ.get('RESULTS_DIR', '/results/xgboost-riclog')
